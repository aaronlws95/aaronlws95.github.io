document.write(`<body>
    ...
    <!-- Personal Details -->
    <div class="personal">
        <b>E-mail:</b> <a href="mailto:aaronlws95@gmail.com" class="text">aaronlws95@gmail.com</a> •
    ...
    <div>
        <dl>
            ...
            <dd>• Deployed models into production with <a class="text"
                    href="https://developer.nvidia.com/tensorrt">TensorRT</a></dd>
            <!-- Materialise -->
    ...
    <div>
        <dl>
            ...
            <dd><b><a class="text" href="https://arxiv.org/abs/2304.09715">UniCal: a Single-Branch Transformer-Based
                        Model for Camera-to-LiDAR Calibration and Validation</b></a> is a novel architecture for
            ...
            <!-- Emocoaster -->
            <dt class="miniheader"><a href="https://aaronlws95.github.io/projects.html#emo-modal"
            ...
            <!-- NeuroSpell -->
            <dt class="miniheader"><a href="https://aaronlws95.github.io/projects.html#ns-modal"
                    class="text">NeuroSpell</a><span class="year">2016</span></dt>
            <dt class="role">Python Developer</dd>
    ...
    <div>
        <dl>
            ...
            <dt class="miniheader"><a href="https://help.edu.my/" class="text">HELP University</a><span
                    class="year">2019 -
                    2020</span></dt>
            <dt class="role">Lecturer, Faculty of Computing and Digital Technology</dd>
            ...
            <dt class="role">Undergraduate Teaching Assistant, Introduction to Computer Architecture</dd>
            ...
            <dt class="role">Co-founder and Secretary</dd>
